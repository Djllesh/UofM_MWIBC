...
if __name__ == "__main__":
    ...
    out_dir = os.path.join(
        __OUT_DIR, "recons/Immediate reference/Recons for Tyson/"
    )
    verify_path(out_dir)
    ...
    for expt in range(n_expts):  # for all scans
        ...
        plt_str_fdnc_das = "Frequency-dependent DAS (zero conductivity)\n"
        ...
        # WARN: The following section was commented because of the
        # adi_cal_cropped_emp variable. Define it before uncommenting.
