...
if __name__ == "__main__":
    ...
    for expt in range(n_expts):  # for all scans
        ...
        if (
            ...
            arc_map = calculate_arc_map_window(
                pix_ts=pix_ts, td_data=td_data, iczt_time=iczt_time
            )

            plot_known_arc_map(
                arc_map=arc_map,
                img_roi=roi_rad * 100,
                save_str=os.path.join(out_dir, f"arc_recon_hom_{expt}.png"),
                tar_x=tum_x * 100,
                tar_y=tum_y * 100,
                tar_rad=tum_rad * 100,
            )
            ...
            plot_known_arc_map(
                arc_map=arc_map,
                img_roi=roi_rad * 100,
                save_str=os.path.join(out_dir, f"arc_recon_bin_{expt}.png"),
                tar_x=tum_x * 100,
                tar_y=tum_y * 100,
                tar_rad=tum_rad * 100,
            )
            ...
            plot_known_arc_map(
                arc_map=arc_map,
                img_roi=roi_rad * 100,
                save_str=os.path.join(out_dir, f"arc_recon_fdnc_{expt}.png"),
                tar_x=tum_x * 100,
                tar_y=tum_y * 100,
                tar_rad=tum_rad * 100,
            )
            ...
            plot_known_arc_map(
                arc_map=arc_map,
                img_roi=roi_rad * 100,
                save_str=os.path.join(out_dir, f"arc_recon_fd_{expt}.png"),
                tar_x=tum_x * 100,
                tar_y=tum_y * 100,
                tar_rad=tum_rad * 100,
            )
            ...
            plot_known_arc_map(
                arc_map=arc_map,
                img_roi=roi_rad * 100,
                save_str=os.path.join(out_dir, f"arc_recon_rt_{expt}.png"),
                tar_x=tum_x * 100,
                tar_y=tum_y * 100,
                tar_rad=tum_rad * 100,
            )
