...
def plt_adi_ref_performance():
    ...
    plt.legend(fontsize=18, loc="upper left", framealpha=0.95)

    plt.xticks([1, 4.5], ["Sensitivity", "Specificity"], size=20)
    ...
    # Save the figure
    plt.savefig(
        os.path.join(__OUT_DIR, "sens_spec_adi_refs.png"),
        dpi=300,
        transparent=False,
    )
...
def plt_fib_ref_performance():
    ...
    # Save fig
    plt.savefig(
        os.path.join(__OUT_DIR, "sens_spec_fib_refs.png"),
        dpi=300,
        transparent=False,
    )
...
def plt_sens_by_tum_adi():
    ...
    plt.xticks(dmas_xs, ["30", "25", "20", "15", "10"], size=20)
    ...
    # Save fig
    plt.savefig(
        os.path.join(__OUT_DIR, "sens_by_tum_adi.png"),
        dpi=300,
        transparent=False,
    )
...
def plt_sens_by_tum_fib():
    ...
    plt.legend(fontsize=18, loc="upper right", framealpha=0.95)
    ...
    plt.savefig(
        os.path.join(__OUT_DIR, "sens_by_tum_fib.png"),
        dpi=300,
        transparent=False,
    )
...
if __name__ == "__main__":
    ...
    das_adi_sens, dmas_adi_sens, orr_adi_sens = load_pickle(
        os.path.join(
            get_proj_path(),
            "output/g3/",
    ...
    das_fib_sens, dmas_fib_sens, orr_fib_sens = load_pickle(
        os.path.join(
            get_proj_path(),
            "output/g3/",
    ...
    das_spec, dmas_spec, orr_spec = load_pickle(
        os.path.join(
            get_proj_path(),
            "output/g3/",
    ...
    das_by_tum_adi, dmas_by_tum_adi, orr_by_tum_adi = load_pickle(
        os.path.join(get_proj_path(), "output/g3/", "adi_sens_by_tums.pickle")
    )
    das_by_tum_fib, dmas_by_tum_fib, orr_by_tum_fib = load_pickle(
        os.path.join(get_proj_path(), "output/g3/", "fib_sens_by_tums.pickle")
    )
