        ...
        if "F" in tar_md["phant_id"]:
            ...
            plot_fd_img(
                ...
                save_str=os.path.join(
                    out_dir, "id_%d_adi_cal_das.png" % tar_md["id"]
                ),
                save_close=True,
                transparent=True,
            )
            ...
            dmas_adi_recon = fd_dmas(
                fd_data=adi_cal_cropped, pix_ts=pix_ts, freqs=scan_fs
            )
            ...
            plot_fd_img(
                ...
                save_fig=True,
                save_str=os.path.join(
                    out_dir, "id_%d_adi_cal_dmas.png" % tar_md["id"]
                ),
                save_close=True,
                transparent=True,
            )
            ...
            adi_orr = orr_recon(
                ini_img=np.zeros([__M_SIZE, __M_SIZE]),
                freqs=scan_fs,
                m_size=__M_SIZE,
                fd=adi_cal_cropped,
                # md=tar_md,
            ...
            plot_fd_img(
                ...
                save_fig=True,
                save_str=os.path.join(
                    out_dir, "id_%d_adi_cal_orr.png" % tar_md["id"]
                ),
                save_close=True,
                transparent=True,
            )
            ...
            if ~np.isnan(tar_md["tum_diam"]):
                ...
                plot_fd_img(
                    ...
                    save_fig=True,
                    save_str=os.path.join(
                        out_dir, "id_%d_fib_cal_das.png" % tar_md["id"]
                    ),
                    save_close=True,
                    transparent=True,
                )
                ...
                plot_fd_img(
                    ...
                    save_fig=True,
                    save_str=os.path.join(
                        out_dir, "id_%d_fib_cal_dmas.png" % tar_md["id"]
                    ),
                    save_close=True,
                    transparent=True,
                )
                ...
                plot_fd_img(
                    ...
                    save_fig=True,
                    save_str=os.path.join(
                        out_dir, "id_%d_fib_cal_gd.png" % tar_md["id"]
                    ),
                    save_close=True,
                    transparent=True,
                )
