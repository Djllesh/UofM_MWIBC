...
__O_DIR = os.path.join(
    get_proj_path(), "output/differential-alignment/spatial_shift/Validation/"
)
verify_path(__O_DIR)
...
if __name__ == "__main__":
    ...
    for md in md_set[1:-1]:
        ...
        cs_left, x_cm_left, y_cm_left = get_boundary_iczt(
            adi_emp_cropped=calibrated_unhealthy,
            ant_rad=ant_rad_bd,
            out_dir="",
            ini_f=2e9,
            fin_f=9e9,
        ...
        right_cal = window_skin_alignment(
            right_cal,
            uncal_unhealthy,
            ant_rad=ant_rad_bd,
            scan_ini_f=__INI_F,
        ...
        save_str = "id%d-0_spatial_shift_%.1f.png" % (
            md["id"],
            md["phant_x_shift"],
        )
