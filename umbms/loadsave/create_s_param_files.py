...
__DATA_DIR = 'C:/Users/Tyson/Desktop/Exp data/20250115/'

fs_in_dir = os.listdir(__DATA_DIR)

s21_data = np.zeros([(int(len(fs_in_dir)) // 2), 1001, 72],
                    dtype=complex)
...
save_pickle(s11_data, os.path.join(__DATA_DIR, '20250115_s11_data.pickle'))
save_pickle(s21_data, os.path.join(__DATA_DIR, '20250115_s21_data.pickle'))
