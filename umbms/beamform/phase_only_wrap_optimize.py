...
if __name__ == "__main__":
    ...
    fig, ax = plt.subplots(
        ...
        sharex=True,
        sharey="row",
        **dict(figsize=(1200 / __MY_DPI, 800 / __MY_DPI), dpi=__MY_DPI),
    )
    ...
    ax.plot(freqs, shape, "k-", label="Fit", linewidth=1.5)
    ...
    fig.savefig(
        os.path.join(
            get_proj_path(), "output/cyl_phantom/unwrapped_phase_ini.png"
        ),
        transparent=True,
    )
