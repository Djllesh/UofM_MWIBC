...
__DATA_DIR = os.path.join(
    "C:/Users/prikh/Desktop/Master's thesis/ursi/data/", "Glycerin.csv"
)
...
if __name__ == "__main__":
    ...
    filename = "data/glycerin_phase.csv"
    ...
    plt.tight_layout()
    # plt.show()
    # plt.savefig('C:/Users/prikh/Desktop/glycerin_phase.png', dpi=__MY_DPI)
